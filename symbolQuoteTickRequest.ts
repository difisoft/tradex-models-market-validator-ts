...
export const symbolQuoteTickRequestSchema = {
...
export function symbolQuoteTickRequestValidator() {
  if (symbolQuoteTickRequestAjv == null) {
    symbolQuoteTickRequestAjv = new Ajv({validateSchema: false}).compile(symbolQuoteTickRequestSchema);
  }
