...
export const symbolQuoteRequestSchema = {
...
export function symbolQuoteRequestValidator() {
  if (symbolQuoteRequestAjv == null) {
    symbolQuoteRequestAjv = new Ajv({validateSchema: false}).compile(symbolQuoteRequestSchema);
  }
