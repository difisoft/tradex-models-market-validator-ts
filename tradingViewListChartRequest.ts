...
export const tradingViewListChartRequestSchema = {
...
export function tradingViewListChartRequestValidator() {
  if (tradingViewListChartRequestAjv == null) {
    tradingViewListChartRequestAjv = new Ajv({validateSchema: false}).compile(tradingViewListChartRequestSchema);
  }
