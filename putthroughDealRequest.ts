...
export const putthroughDealRequestSchema = {
...
export function putthroughDealRequestValidator() {
  if (putthroughDealRequestAjv == null) {
    putthroughDealRequestAjv = new Ajv({validateSchema: false}).compile(putthroughDealRequestSchema);
  }
