...
export const topForeignerTradingResponseSchema = {
...
export function topForeignerTradingResponseValidator() {
  if (topForeignerTradingResponseAjv == null) {
    topForeignerTradingResponseAjv = new Ajv({validateSchema: false}).compile(topForeignerTradingResponseSchema);
  }
