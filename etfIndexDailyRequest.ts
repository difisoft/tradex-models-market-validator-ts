...
export const etfIndexDailyRequestSchema = {
...
export function etfIndexDailyRequestValidator() {
  if (etfIndexDailyRequestAjv == null) {
    etfIndexDailyRequestAjv = new Ajv({validateSchema: false}).compile(etfIndexDailyRequestSchema);
  }
