...
export const symbolPeriodRequestSchema = {
...
export function symbolPeriodRequestValidator() {
  if (symbolPeriodRequestAjv == null) {
    symbolPeriodRequestAjv = new Ajv({validateSchema: false}).compile(symbolPeriodRequestSchema);
  }
