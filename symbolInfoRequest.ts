...
export const symbolInfoRequestSchema = {
...
export function symbolInfoRequestValidator() {
  if (symbolInfoRequestAjv == null) {
    symbolInfoRequestAjv = new Ajv({validateSchema: false}).compile(symbolInfoRequestSchema);
  }
