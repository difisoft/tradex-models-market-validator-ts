...
exports.symbolInfoRequestSchema = {
    ...
    "description": "symbolInfoRequest schema",
    "type": "object",
    "allOf": [
        {
...
let symbolInfoRequestAjv = null;
function symbolInfoRequestValidator() {
    if (symbolInfoRequestAjv == null) {
        symbolInfoRequestAjv = new Ajv({ validateSchema: false }).compile(exports.symbolInfoRequestSchema);
    }
    return symbolInfoRequestAjv;
}
exports.symbolInfoRequestValidator = symbolInfoRequestValidator;
//# sourceMappingURL=symbolInfoRequest.js.map