...
exports.foreignerSummaryRequestValidator = exports.foreignerSummaryRequestSchema = void 0;
...
function foreignerSummaryRequestValidator() {
    if (foreignerSummaryRequestAjv == null) {
        foreignerSummaryRequestAjv = new Ajv({ validateSchema: false }).compile(exports.foreignerSummaryRequestSchema);
    }
    return foreignerSummaryRequestAjv;
}
exports.foreignerSummaryRequestValidator = foreignerSummaryRequestValidator;
//# sourceMappingURL=foreignerSummaryRequest.js.map