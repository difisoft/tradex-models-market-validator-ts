...
exports.topAiRatingRequestSchema = {
    ...
    "description": "topAiRatingRequest schema",
    "type": "object",
    "allOf": [
        {
...
let topAiRatingRequestAjv = null;
function topAiRatingRequestValidator() {
    if (topAiRatingRequestAjv == null) {
        topAiRatingRequestAjv = new Ajv({ validateSchema: false }).compile(exports.topAiRatingRequestSchema);
    }
    return topAiRatingRequestAjv;
}
exports.topAiRatingRequestValidator = topAiRatingRequestValidator;
//# sourceMappingURL=topAiRatingRequest.js.map