...
exports.symbolInfoResponseValidator = exports.symbolInfoResponseSchema = void 0;
const Ajv = require("ajv");
exports.symbolInfoResponseSchema = {
...
function symbolInfoResponseValidator() {
    if (symbolInfoResponseAjv == null) {
        symbolInfoResponseAjv = new Ajv({ validateSchema: false }).compile(exports.symbolInfoResponseSchema);
    }
    return symbolInfoResponseAjv;
}
exports.symbolInfoResponseValidator = symbolInfoResponseValidator;
//# sourceMappingURL=symbolInfoResponse.js.map