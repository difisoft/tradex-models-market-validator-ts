...
export const etfNavDailyRequestSchema = {
...
export function etfNavDailyRequestValidator() {
  if (etfNavDailyRequestAjv == null) {
    etfNavDailyRequestAjv = new Ajv({validateSchema: false}).compile(etfNavDailyRequestSchema);
  }
