...
export const stockRankingUpDownResponseSchema = {
...
export function stockRankingUpDownResponseValidator() {
  if (stockRankingUpDownResponseAjv == null) {
    stockRankingUpDownResponseAjv = new Ajv({validateSchema: false}).compile(stockRankingUpDownResponseSchema);
  }
