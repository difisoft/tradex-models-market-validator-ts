...
export const topAiRatingRequestSchema = {
...
export function topAiRatingRequestValidator() {
  if (topAiRatingRequestAjv == null) {
    topAiRatingRequestAjv = new Ajv({validateSchema: false}).compile(topAiRatingRequestSchema);
  }
