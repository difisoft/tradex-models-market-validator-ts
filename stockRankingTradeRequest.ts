...
export const stockRankingTradeRequestSchema = {
...
export function stockRankingTradeRequestValidator() {
  if (stockRankingTradeRequestAjv == null) {
    stockRankingTradeRequestAjv = new Ajv({validateSchema: false}).compile(stockRankingTradeRequestSchema);
  }
